...
export default function ProfilPage() {
  ...
  const [showMissionsModal, showMissionsModal] = useState(false)
  ...
  return (
    <DashboardLayout>
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
              ...
              <div className="relative group">
                ...
                <label className="absolute bottom-2 right-2 bg-gradient-to-r from-[#52c1ff] to-[#ffbb88] rounded-2xl p-3 cursor-pointer hover:scale-110 transition-transform shadow-lg group">
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3">
              <div className="p-2 bg-gradient-to-r from-[#52c1ff] to-[#ffbb88] rounded-xl">
      ...
      {showAbonnesModal && (
      <ModalAbonnes userId={userInfo.id} onClose={() => setShowAbonnesModal(false)} />
    )}

    {showAbonnementsModal && (
      <ModalAbonnements userId={userInfo.id} onClose={() => setShowAbonnementsModal(false)} />
    )}

    {showAvisModal && (
      <ModalAvis userId={userInfo.id} onClose={() => setShowAvisModal(false)} />
    )}
...
function StatCard({
  ...
  return (
    <div
      onClick={onClick}
      className="cursor-pointer bg-white/80 backdrop-blur-xl rounded-2xl shadow-lg border border-white/20 p-4 hover:shadow-xl transition-all duration-300"
    >      
