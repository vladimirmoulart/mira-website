...
export default function RechercherMission() {
  ...
  useEffect(() => {
    ...
    This comparison appears to be unintentional because the types '"loading" | "success" | "error" | undefined' and '"acceptée"' have no overlap.ts(2367)
Windsurf: Explain Problem

(parameter) postulationStatus: "loading" | "success" | "error" 
