  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setMissionsAffichables(missionsData)
        ...
        <div className="max-w-7xl mx-auto space-y-8">
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <div className="bg-[#ffbb88] rounded-xl px-4 py-3">
                  <span className="text-sm font-medium text-white">
                    {missionsAffichables.length} mission{missionsAffichables.length !== 1 ? "s" : ""} trouvée
                    {missionsAffichables.length !== 1 ? "s" : ""}
                  </span>
                </div>
              </div>
            </div>
          ...
          {filteredMissions.length > 0 ? (
            <div className="columns-1 lg:columns-2 xl:columns-3 gap-6 space-y-6">
              {filteredMissions
                  .filter((mission) => mission.statut !== "terminée" && mesPostulations[mission.id] !== "acceptée")
                .map((mission, index) => {
              ...
              : postulationStatus === "refusée"
                ...
                : postulationStatus === "en_attente"
                  ...
                  : isSubmitting
                    ...
                    : "bg-[#52c1ff] hover:bg-[#52c1ff]/90 text-white hover:shadow-lg"
          }`}
        >
          {postulationStatus === "acceptée" && (
            <>
