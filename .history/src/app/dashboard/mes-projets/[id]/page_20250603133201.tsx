...
export default function ProjetDetailPage() {
  ...
  const handleSubmitRating = async () => {
    ...
    try {
      // Save rating to database (you'll need to create a ratings table)
      const { error: ratingError } = await supabase.from("ratings").insert({
        mission_id: mission?.id,
        rated_by: utilisateur?.id,
        rating: rating,
        comment: comment,
      ...
      if (ratingError) {
        console.error("Erreur lors de l'enregistrement de la note:", ratingError)
      ...
      alert("Mission validée et note enregistrée avec succès !")
