...
import { LayoutDashboard, Building2, UploadCloud, Users, LogOut, ChevronRight } from "lucide-react"
...
export default function Navbar({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const fetchUser = async () => {
      ...
      const { data, error } = await supabase.from("utilisateurs").select("nom, avatar").eq("id", userId).single()
  ...
  const navItems = [
    ...
    { icon: Building2, label: "Mes projets", href: "/dashboard/mes-projets" },
    { icon: UploadCloud, label: "Proposer une mission", href: "/dashboard/proposer-une-mission" },
    { icon: Users, label: "Trouver un talent", href: "/dashboard/rechercher-un-talent" },
  ]
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-[#52c1ff] font-medium">Entreprise</p>
            </div>
