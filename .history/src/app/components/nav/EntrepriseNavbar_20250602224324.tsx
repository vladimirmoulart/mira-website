...
export default function Navbar( { children }: { children: ReactNode}) {
 ...
 useEffect(() => {
  ...
  return (
    <div className="flex">
    <aside className="fixed top-0 left-0 h-screen bg-gradient-to-b from-slate-50/95 to-white/95 backdrop-blur-xl border-r border-slate-200/60 shadow-xl z-50 flex flex-col">
      {/* Logo */}
