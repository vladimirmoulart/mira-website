...
export default function ModalProfil({ userId, onClose }: { userId: string; onClose: () => void }) {
  ...
  {showAbonnesModal && (
      <ModalAbonnes userId={user.id} onClose={() => setShowAbonnesModal(false)} />
    )}
    {showAbonnementsModal && (
      <ModalAbonnements userId={user.id} onClose={() => setShowAbonnementsModal(false)} />
    )}
    {showAvisModal && (
      <ModalAvis userId={user.id} onClose={() => setShowAvisModal(false)} />
    )}
    {showMissionsModal && (
      <ModalMissions userId={user.id} onClose={() => setShowMissionsModal(false)} />
    )}
