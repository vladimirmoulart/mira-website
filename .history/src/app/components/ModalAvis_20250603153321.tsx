      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md relative max-h-[85vh] overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Avis reçus</h2>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {avis.map((a, index) => (
                <div
                  key={a.id}
                  className="bg-gray-50 hover:bg-amber-50/30 rounded-xl p-5 border border-gray-100 hover:border-amber-200 transition-all duration-200"
                ...
                >
                  ...
                  <p className="text-sm text-gray-700 leading-relaxed">{a.comment || "Pas de commentaire"}</p>
